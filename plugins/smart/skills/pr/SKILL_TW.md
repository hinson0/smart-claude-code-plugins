...
- 確定 PR 標題、Summary 和 Test Plan 的語言：預設使用英文。僅當專案的 `CLAUDE.md` 或 `CLAUDE.local.md` 明確指定了 PR/commit 內容語言時，才使用指定語言。Section headers（## Summary、## Commits、## Test Plan）始終保持英文，commit messages 不翻譯。
