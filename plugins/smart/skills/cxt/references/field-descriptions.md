# Statusline Field Descriptions

Bilingual descriptions for annotating the JSONC output. Use the column matching the user's language.
...
These fields appear only when their feature is active.
