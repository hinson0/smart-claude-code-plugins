...
| `/smart:config` | 자동 작업 설정 (매 작업 후 자동 commit/push) |

---

## 자동 작업 (Auto-Action)

Claude가 매 작업 완료 후 자동으로 커밋하거나 푸시하도록 설정하려면 한 번만 구성하세요:
...
선택 옵션:
- **off** — 비활성화 (기본값, 수동만)
- **commit** — 매 작업 후 자동 commit (로컬만)
- **push** — 매 작업 후 자동 commit + push

설정은 프로젝트별로 `.claude/smart.local.md`에 저장되며, 다음 세션부터 적용됩니다.
